...
<link href='http://fonts.googleapis.com/css?family=Ropa+Sans' rel='stylesheet' type='text/css'>
	...
	<div class="wrap">
		<!----start-Header---->
			...
			<div class="top-nav" >
				<ul>
					...
					<li><a href="myChannel.html">My Channel</a><p>About this blog</p></li>
		...
		<div class="content">
			<div class="left-content">
				...
				<div class="grids">
					<div class="grid">
						<h3>Consectetur adipisicing elit</h3>
						<a href="single.html"><img src="img/g3.jpg" title="video-name" /></a>
						<div class="time">
							<span>2:30</span>
						</div>
						<div class="grid-info">
					...
					<div class="grid">
						<h3>Consectetur adipisicing elit</h3>
						<a href="single.html"><img src="img/g5.jpg" title="video-name" /></a>
						<div class="time">
							<span>5:10</span>
						</div>
						<div class="grid-info">
				...
				<div class="grids">
					<div class="grid">
						<h3>Consectetur adipisicing elit</h3>
						<a href="single.html"><img src="img/g6.jpg" title="video-name" /></a>
						<div class="time">
							<span>12:10</span>
						</div>
						<div class="grid-info">
					...
					<div class="grid">
						<h3>Consectetur adipisicing elit</h3>
						<a href="single.html"><img src="img/g7.jpg" title="video-name" /></a>
						<div class="time">
							<span>20:10</span>
						</div>
						<div class="grid-info">
					...
					<div class="grid">
						<h3>Consectetur adipisicing elit</h3>
						<a href="single.html"><img src="img/g8.jpg" title="video-name" /></a>
						<div class="time">
							<span>2:50</span>
						</div>
						<div class="grid-info">
		...
		<button type="button" class="register-but"><a style="color:white;" href="/WEB-INF/views/jsp/register.jsp">Register</a></button>
